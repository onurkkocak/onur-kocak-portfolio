  ...
  <div class="shell">
    <div class="footer__grid">
      <div class="footer__brand">
        ...
        <p class="footer__blurb" data-en="Mobile apps and games, built end to end.">
          Uçtan uca geliştirilen mobil uygulamalar ve oyunlar.
        </p>
      </div>
  ...
  sections.push(
    {
      ...
      body: `        <p data-en="Data is kept only for as long as the feature it belongs to requires it, and is protected with industry-standard measures such as encrypted transport. No method of transmission over the internet is ever completely secure, so absolute security cannot be guaranteed.">
        ...
        <p data-en="App data is held on Supabase servers located in Europe. The other services named above run on their own providers' infrastructure, which may sit outside Europe — so some data is processed outside Turkey.">
          Uygulama verileri Supabase'in <strong>Avrupa'daki</strong> sunucularında tutulur. Yukarıda adı geçen diğer servisler kendi sağlayıcılarının altyapısında çalışır ve bu sunucular Avrupa dışında olabilir; dolayısıyla bazı veriler Türkiye dışında işlenir.
        </p>
